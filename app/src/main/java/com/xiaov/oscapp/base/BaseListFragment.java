...
import com.xiaov.oscapp.bean.Entity;
import com.xiaov.oscapp.bean.ListEntity;
import com.xiaov.oscapp.bean.Result;
import com.xiaov.oscapp.bean.ResultBean;
...
public abstract class BaseListFragment<T extends Entity>extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, AdapterView.OnItemClickListener, AbsListView.OnScrollListener {
    ...
    protected AsyncHttpResponseHandler mHandler = new AsyncHttpResponseHandler() {
        ...
        public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
            Log.e("444444444", "onSuccess:statusCode: "+statusCode+"responseBytes:"+responseBody.toString());
        ...
        public void onFailure(int arg0, Header[] arg1, byte[] arg2, Throwable arg3) {
            Log.e("3333333", "onSuccess:statusCode: "+arg0+"responseBytes:"+arg2.toString());
            if (isAdded()) {
